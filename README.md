...
- [here's](https://github.com/thogag/Nicotine_Impact_on_Neurogenesis_snRNAseq_R/blob/main/nicotine_impact_on_neurogenesis_poster.pdf) the poster presented to some researchers in order to explain my method and my pipeline
