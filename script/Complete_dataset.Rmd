...
```{r}
# 1. Identifier les gènes mitochondriaux
...
# 4. Suppression dans scale.data (si présent)
...
p_annot
ggsave("C:/Users/tomga/Desktop/github/Nicotine_Impact_on_Neurogenesis_snRNAseq/plot/allcells/tSNE_annotated.png", plot = p_annot, width = 15, height = 10, dpi = 300)
```
